/**
 * @author: Pulak Saha
 * @description: This file contains a card test for the implementation of Great Hall.
**/
...
int main(int argc, char** argv)
{
    ...
    printf("* Test Case: numActions increments by one after play *\n");
    assert_true(1, state.numActions, CARD_NAME);
